        ...
        <div class="mt-8">
            ...
            @else
                <button
                    ...
                    rounded-xl transition duration-150 ease-in px-4 py-3"
                >
                    Vote
                </button>
            @endif
                ...
                <div class="flex items-center md:hidden mt-4 md:mt-0">
                    ...
                    @if($hasVoted)
                        <button
                            ...
                            border-blue hover:bg-blue-hover font-bold
                            text-xxs uppercase rounded-xl transition
                    ...
                    @else
                        <button
                            ...
                            class="w-20 bg-gray-200 border
                             hover:bg-blue-hover font-bold text-xxs
                             uppercase rounded-xl transition duration-150
