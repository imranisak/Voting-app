                        ...
                        @if ($hasVoted)
                            <button
                                ...
                                class="w-20 bg-blue text-white border
                                 border-blue font-bold text-xxs uppercase
                                 rounded-xl hover:bg-blue-hover transition
                        ...
                        @else
                            <button
                                ...
                                class="w-20 bg-gray-200 border
                                 border-gray-200 font-bold text-xxs uppercase
                                  rounded-xl hover:border-gray-400 transition
                                  duration-150 ease-in px-4 py-3 -mx-5"
                            >
                                Vote
                            </button>
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
            ...
            >
                ...
                >
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div>
                            <textarea name="postComment" id="post_comment" cols="30" rows="4" class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 border-none px-4 py-2" placeholder="Go ahead, don't be shy. Share your thoughts..."></textarea>
                        </div>
            ...
            >
                ...
                >
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div>
                            <textarea name="updateComment" id="update_comments" cols="30" rows="3" class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 border-none px-4 py-2" placeholder="Add an update comment (optional)"></textarea>
                        </div>
                        ...
                        <div>
                            <label class="font-normal inline-flex items-center">
                                <input type="checkbox" name="notifyVoters" class="rounded bg-gray-200" checked="">
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            @if ($hasVoted)
                <button
                    wire:click.prevent="vote"
                    class="w-20 bg-blue text-white
                        border border-blue hover:bg-blue-hover
                        font-bold text-xxs uppercase rounded-xl
            ...
            @else
                <button
                    wire:click.prevent="vote"
                    class="w-20 bg-gray-200
                        border border-gray-200
                        hover:border-gray-400
                        font-bold text-xxs uppercase
