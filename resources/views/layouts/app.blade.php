...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <main>
        <div class="container mx-auto max-w-custom flex" style="max-width: 1000px">
            <div class="w-70 mr-5">Add idea form, Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta est hic ipsum iure maxime qui. A assumenda atque debitis dignissimos doloribus ducimus eligendi esse eveniet facilis incidunt inventore ipsum itaque labore modi natus possimus quidem quod, voluptas. Amet id, voluptatibus.</div>
            <div class="w-175">
