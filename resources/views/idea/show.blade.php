<x-app-layout>
            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    <div class="flex items-center md:hidden mt-4 md:mt-0">
                        ...
                        <button class="w-20 bg-gray-200 border hover:bg-blue-hover font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3 -mx-5">Vote</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--comment form and status change-->
